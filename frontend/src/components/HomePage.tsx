...
export function HomePage() {
  return (
    <div className="flex flex-col text-center">
      ...
      <Link
        className="bg-purple-600 text-white w-64 py-2 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-800 focus:ring-opacity-50 mb-8"
        to="/user"
      >
        Join A Quiz
      </Link>
